...
```
baileys-server/
├── index.js          # Servidor (único arquivo)
...
### 1. Crie um repositório GitHub com estes 2 arquivos:
- `package.json`
- `index.js`

### 2. No Railway, configure as variáveis:
...
- Certifique-se de que a variável SUPABASE_WEBHOOK_URL está correta
