...
const DashboardHome: React.FC<DashboardHomeProps> = ({ onStartCarousel, onLoadCarousel, onViewAllProjects }) => {
  ...
  return (
    <div className="flex-1 flex flex-col relative overflow-hidden" style={{ backgroundColor: '#0a0a0f', minHeight: 0 }}>
      ...
      <div className="absolute left-1/2 -translate-x-1/2 pointer-events-none top-[60%] -translate-y-1/2 md:top-1/2" style={{ opacity: 0.85 }}>
        <div className="carousel-loader-wrapper w-[120vw] h-[120vw] md:w-[900px] md:h-[900px]">
