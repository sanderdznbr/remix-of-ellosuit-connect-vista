...
export async function renderTweetToImage(
  ...
  if (textLen < 60) tweetFontSize = 52;
  else if (textLen < 120) tweetFontSize = 40;
  else if (textLen < 200) tweetFontSize = 32;
  else tweetFontSize = 26;
    ...
    ">
      ...
      <div style="padding: 0 64px;">
        ...
        <div style="display: flex; align-items: center; margin-bottom: 20px;">
          ${config.profilePhoto
            ? `<img src="${config.profilePhoto}" style="width: 56px; height: 56px; border-radius: 50%; object-fit: cover; margin-right: 14px;" crossorigin="anonymous" />`
            : `<div style="width: 56px; height: 56px; border-radius: 50%; background: ${isDark ? '#2F3336' : '#CFD9DE'}; margin-right: 14px;"></div>`
          }
          <div style="flex: 1;">
            <div style="display: flex; align-items: center; gap: 6px;">
              <span style="font-weight: 700; font-size: 20px; color: ${textColor}; line-height: 1.3;">
                ${escapeHtml(config.displayName || 'User')}
              </span>
              ${config.isVerified ? `
                <svg viewBox="0 0 22 22" width="22" height="22" style="flex-shrink: 0;">
            ...
            <span style="font-size: 17px; color: ${subColor}; line-height: 1.3;">
              @${escapeHtml(config.username || 'user')} · ${hours}h
            </span>
          </div>
          <!-- X logo -->
          <svg viewBox="0 0 24 24" width="28" height="28" style="flex-shrink: 0; fill: ${subColor};">
        ...
        <div style="
          ...
          line-height: 1.35;
          color: ${textColor};
          margin-bottom: ${hasPhoto ? 20 : 28}px;
        ...
        ">
          <div style="display: flex; align-items: center; gap: 8px;">
            <svg viewBox="0 0 24 24" width="22" height="22" fill="none" stroke="${subColor}" stroke-width="1.5">
