...
export const BACKGROUND_STYLES: BackgroundStyleOption[] = [
  ...
  },
  {
    ...
    label: 'Granulado',
    css: (bg, accent) =>
      `background: linear-gradient(160deg, ${bg} 0%, ${accent}18 100%);`,
  },
  {
    id: 'circles',
    label: 'Círculos',
...
function parseCssToStyle(cssStr: string): React.CSSProperties {
    ...
    <div className="space-y-5">
      ...
      <div className="grid grid-cols-3 sm:grid-cols-4 gap-3">
        {BACKGROUND_STYLES.map((style, idx) => {
          ...
          const inlineStyle = parseCssToStyle(cssStr);
          ...
          return (
            ...
            >
              ...
              >
                <div className="absolute inset-0" style={inlineStyle} />

                {/* Mini preview text lines */}
