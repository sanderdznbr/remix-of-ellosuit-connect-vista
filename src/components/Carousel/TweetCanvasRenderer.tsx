...
export async function renderTweetToImage(
  ...
  const verifiedSize = Math.round(26 * fontScale);
      ...
      <div style="padding: 0 ${horizontalPadding}px; display: flex; flex-direction: column; justify-content: center; flex: 1;">
        ...
        <div style="display: flex; align-items: center; margin-bottom: ${Math.round(32 * paddingScale)}px; gap: ${headerGap}px;">
          ...
          <div style="display: flex; flex-direction: column; justify-content: center; min-width: 0; height: ${avatarSize}px;">
            <div style="display: flex; align-items: flex-start; gap: ${nameRowGap}px; min-width: 0;">
              ...
              ${config.isVerified ? `
                <span style="display: flex; align-items: center; height: ${Math.round(nameFontSize * nameLineHeight)}px; padding-top: ${Math.max(0, Math.round(2 * paddingScale))}px; flex-shrink: 0;">
