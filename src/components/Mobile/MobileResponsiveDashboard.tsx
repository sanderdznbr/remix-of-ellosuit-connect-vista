...
import BrandAssetsPage from '@/components/BrandAssets/BrandAssetsPage';
  ...
  return (
    <Routes>
      ...
      <Route path="admin" element={<AdminLayout />}>
        ...
        <Route path="costs" element={<AdminCostsPanel />} />
        <Route path="tutorials" element={<AdminTutorialsPanel />} />
      </Route>
      ...
      <Route path="*" element={
        <DashboardLayout>
          <Routes>
            ...
            <Route path="/carrossel" element={<Navigate to="/gerador-de-carrosseis" replace />} />
