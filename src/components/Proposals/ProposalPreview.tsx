...
export default function ProposalPreview({
  ...
  return (
    <div className="bg-white flex flex-col text-[11px] leading-relaxed" style={{ fontFamily, width: 595, minHeight: 842 }}>
      {/* Header */}
      {showHeader && (
      ...
      <div className="px-8 py-6 space-y-5 flex-1">
        ...
        {client && (
          <div className="rounded-lg p-3" style={{ backgroundColor: secondaryColor + '12' }}>
