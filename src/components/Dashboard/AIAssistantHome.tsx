...
const quickAccessItems = [
  ...
  { icon: Calendar, label: 'Agenda', path: '/dashboard/agenda', color: 'from-purple-500 to-purple-600' },
  { icon: Mail, label: 'Email', path: '/dashboard/email', color: 'from-red-500 to-red-600' },
  { icon: Users, label: 'Clientes', path: '/dashboard/clientes', color: 'from-green-500 to-green-600' },
  { icon: CheckSquare, label: 'Tarefas', path: '/dashboard/tasks', color: 'from-orange-500 to-orange-600' },
  { icon: FileText, label: 'Arquivos', path: '/dashboard/drive', color: 'from-indigo-500 to-indigo-600' },
  { icon: Bot, label: 'IA Agentes', path: '/dashboard/bot-ia', color: 'from-pink-500 to-pink-600' },
  { icon: Zap, label: 'Fluxos', path: '/dashboard/fluxos', color: 'from-yellow-500 to-yellow-600' },
  { icon: BarChart3, label: 'Análises', path: '/dashboard/analytics', color: 'from-cyan-500 to-cyan-600' },
  { icon: Settings, label: 'Configurações', path: '/dashboard/configuracoes', color: 'from-gray-500 to-gray-600' }
];
              ...
              {quickAccessItems.map((item) => {
                ...
                return (
                  <Button
                    ...
                    variant="outline"
                    className="h-auto flex flex-col items-center gap-3 p-6 hover:shadow-md transition-all group"
                  >
