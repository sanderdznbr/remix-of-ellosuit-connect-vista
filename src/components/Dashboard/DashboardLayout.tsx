...
export function DashboardLayout({ children }: { children?: React.ReactNode }) {
  ...
  return (
    <div className="flex flex-col h-[100dvh] bg-background overflow-hidden">
      ...
      <main className={`flex-1 min-h-0 w-full ${isMobile && !isCrmWhatsApp ? 'pt-[calc(3.5rem+env(safe-area-inset-top))] pb-[calc(4rem+env(safe-area-inset-bottom))]' : ''} overflow-y-auto overscroll-none`} style={{ scrollbarGutter: 'stable' }}>
        {children}
      </main>
