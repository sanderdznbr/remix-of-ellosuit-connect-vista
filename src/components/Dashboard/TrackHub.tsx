...
import { FileText, Link2, PlayCircle, Mail, Radio, Eye, MousePointer, ArrowRight } from "lucide-react";
...
const trackModules = [
  {
    ...
    description: "Saiba quem abriu seus PDFs, quanto tempo leram e quais páginas visualizaram",
    icon: FileText,
  ...
  },
  {
    ...
    description: "Crie links rastreáveis e acompanhe cada clique em tempo real com analytics",
    icon: Link2,
  ...
  },
  {
    ...
    description: "Monitore visualizações, tempo assistido e engajamento dos seus vídeos",
    icon: PlayCircle,
    ...
    <div className="min-h-screen bg-white">
      ...
      >
        ...
        <div className="max-w-7xl mx-auto px-6 py-16 relative">
          <div className="flex items-center gap-4 mb-6">
            ...
            <div>
              <h1 className="text-4xl font-bold text-white">Ellosuit Track</h1>
              <p className="text-white/80 text-lg">Rastreamento Inteligente</p>
            </div>
          </div>
            ...
            {stats.map((stat, i) => {
              ...
              return (
                <div key={i} className="text-center">
                  ...
                  >
                    <Icon className="h-7 w-7" style={{ color: TRACK_COLOR }} />
                  </div>
      ...
      <div className="max-w-7xl mx-auto px-6 py-12">
        <div className="flex items-center justify-between mb-8">
          <h2 className="text-2xl font-bold text-gray-900">Tipos de Rastreamento</h2>
        </div>
          ...
          {trackModules.map((module) => {
            ...
            return (
              <Link
                ...
                onMouseEnter={(e) => {
                  e.currentTarget.style.boxShadow = `0 25px 50px -12px ${TRACK_COLOR}25`;
                  e.currentTarget.style.borderColor = `${TRACK_COLOR}30`;
                }}
                onMouseLeave={(e) => {
