        ...
        <div style="display: flex; align-items: center; margin-bottom: ${Math.round(32 * paddingScale)}px; gap: ${headerGap}px;">
          ...
          <div style="display: flex; flex-direction: column;">
            <div style="display: flex; align-items: center; gap: 6px;">
              ...
              ${config.isVerified ? `
                <svg viewBox="0 0 22 22" width="${verifiedSize}" height="${verifiedSize}" style="flex-shrink: 0; display: inline-block; vertical-align: middle;">
            ...
            <span style="font-size: ${usernameFontSize}px; color: ${subColor}; line-height: 1.3;">
