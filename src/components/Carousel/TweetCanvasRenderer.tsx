    ...
    ">
      <div style="padding: 0 ${horizontalPadding}px; display: flex; flex-direction: column; justify-content: center; flex: 1;">
        ...
        <div style="display: flex; align-items: flex-start; margin-bottom: ${Math.round(32 * paddingScale)}px; gap: ${headerGap}px;">
          ${config.profilePhoto
            ? `<img src="${config.profilePhoto}" style="width: ${avatarSize}px; height: ${avatarSize}px; border-radius: 50%; object-fit: cover; flex-shrink: 0; margin-top: 4px;" crossorigin="anonymous" />`
            : `<div style="width: ${avatarSize}px; height: ${avatarSize}px; border-radius: 50%; background: ${isDark ? '#2F3336' : '#CFD9DE'}; flex-shrink: 0; margin-top: 4px;"></div>`
          }
          <div style="display: flex; flex-direction: column;">
            <div style="display: flex; align-items: center; gap: 6px; line-height: 1;">
              ...
              ${config.isVerified ? `
                <svg viewBox="0 0 22 22" width="${verifiedSize}" height="${verifiedSize}" style="flex-shrink: 0;">
