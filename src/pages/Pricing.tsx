...
const PLAN_CONFIG: Record<string, { label: string; price: number; credits: number; extraCredit: number }> = {
  starter: { label: 'Starter', price: 29, credits: 100, extraCredit: 1.50 },
  pro: { label: 'Pro', price: 79, credits: 400, extraCredit: 0.90 },
  growth: { label: 'Growth', price: 149, credits: 1200, extraCredit: 0.50 },
};
...
const plans = [
  {
    ...
    price: 'R$29',
    period: '/mês',
    subtitle: '100 créditos · ~12 carrosséis',
    badge: null,
    includedLabel: 'O que está incluso:',
    features: [
      '100 créditos mensais',
      'Carrosséis com IA + imagens geradas',
  ...
  },
  {
    key: 'pro',
    name: 'Pro',
    description: 'Para criadores que publicam conteúdo visual todos os dias.',
    price: 'R$79',
    period: '/mês',
    subtitle: '400 créditos · ~50 carrosséis',
    badge: 'Mais popular',
  ...
  },
  {
    key: 'growth',
    name: 'Growth',
    description: 'Escale sua produção com volume, equipe e recursos ilimitados.',
    price: 'R$149',
    period: '/mês',
    subtitle: '1.200 créditos · ~150 carrosséis',
    badge: null,
