...
const StepFaceRef: React.FC<Props> = ({
  ...
  return (
    <div className="space-y-5" style={{ minHeight: '300px' }}>
      ...
      {/* Web search info banner (position selection moved to separate step) */}
      {hasWebImages && (
        <div className="p-3 rounded-xl bg-blue-500/10 border border-blue-500/20 flex items-start gap-2.5">
          ...
          <div>
            ...
            <p className="text-xs text-blue-300/70 mt-0.5">
              Fotos reais do tema serão usadas nos cards. Se adicionar um rosto, na próxima etapa você escolhe onde aplicá-lo.
            </p>
          </div>
        </div>
      )}
