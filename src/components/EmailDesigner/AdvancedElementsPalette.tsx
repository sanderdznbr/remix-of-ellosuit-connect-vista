...
const elementCategories = [
  ...
  },
  {
    name: 'Conteúdo',
    elements: [
      { id: 'quote', label: 'Citação', icon: Quote, type: 'quote', description: 'Bloco de citação' },
      { id: 'rating', label: 'Avaliação', icon: Star, type: 'rating', description: 'Sistema de estrelas' },
      { id: 'testimonial', label: 'Depoimento', icon: Heart, type: 'testimonial', description: 'Depoimento de cliente' },
    ]
  },
  {
    name: 'Contato',
    elements: [
      { id: 'address', label: 'Endereço', icon: MapPin, type: 'address', description: 'Informações de endereço' },
      { id: 'phone', label: 'Telefone', icon: Phone, type: 'phone', description: 'Número de telefone' },
      { id: 'email', label: 'Email', icon: Mail, type: 'email', description: 'Endereço de email' },
      { id: 'calendar', label: 'Calendário', icon: Calendar, type: 'calendar', description: 'Data e hora' },
    ]
  }
];
...
export const AdvancedElementsPalette: React.FC = () => {
  return (
