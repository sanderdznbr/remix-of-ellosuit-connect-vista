            ...
            return (
              <div key={i} className="relative group">
                <button onClick={() => {
                  ...
                  className={`w-full rounded-lg overflow-hidden aspect-video ring-1 transition-all ${
                    alreadyAdded ? 'ring-purple-500/60 ring-2' : 'ring-white/[0.06] hover:ring-white/20'
                  }`}>
